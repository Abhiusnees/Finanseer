  ...
  const formattedData = useMemo(() => {
    ...
    return monthData.map(({ month, revenue }, i: number) => {
      return {
        ...
        "Regression Line": regressionLine.points[i][1], //grabbing the y value for the current month
        "Predicted Revenue": regressionLine.predict(i + 12)[1], //predicting the value for next year by adding 12
      };
    });
  }, [kpiData]);
  return (
